...
{
    /// <summary>
    ///     A ContinuousLineString is a Curve with linear interpolation between points. Each consecutive pair of points defines a
    ///     line segment.
    /// </summary>
    public class ContinuousLineString : Geometry
    {
        /// <summary>
        ///     Initializes an instance of a LineString from a set of vertices
        /// </summary>
        /// <param name="vertices"></param>
        public ContinuousLineString(IEnumerable<Point> vertices)
        {
        ...
        /// </summary>
        public ContinuousLineString() : this(new List<Point>()) {}

        /// <summary>
        ///     Initializes an instance of a LineString
        /// </summary>
        /// <param name="points"></param>
        public ContinuousLineString(IEnumerable<double[]> points)
        {
        ...
        public new ContinuousLineString Clone()
        {
            var l = new ContinuousLineString();
        ...
        public bool Equals(ContinuousLineString lineString)
        {
        ...
        {
            var lineString = geom as ContinuousLineString;
        ...
        public List<ContinuousLineString> GetSegments()
        {
            List<ContinuousLineString> segments = new List<ContinuousLineString>();
            for (int i = 0; i < Vertices.Count - 1; i++)
            {
                ContinuousLineString tmp = new ContinuousLineString();
